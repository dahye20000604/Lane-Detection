...
while cap.isOpened():
    ...
    for i in range(len(point_l) - 1):
        cv2.line(img, point_l[i], point_l[i + 1], (255, 255, 255), 2)
    for i in range(len(point_r) - 1):
        cv2.line(img, point_r[i], point_r[i + 1], (255, 255, 255), 2)
